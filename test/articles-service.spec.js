...
//         {
//             id: 1,
//             date_published: new Date('2019-08-14T18:44:19.583Z'),
...
//             //check that ArticlesService.getAllArticles gets data from table
...
//             const updateArticleId = 3;
//             const newArticleData = {
//                 title: 'updated title',
//                 content: 'updated content',
//                 date_published: new Date(),
//             };
//             return ArticlesService.updateArticle(db, updateArticleId, newArticleData)
//                 .then(() => ArticlesService.getById(db, updateArticleId))
//                 .then(article => {
